...
export interface HiIQAbiInterface extends utils.Interface {
  contractName: "HiIQAbi";
  functions: {
    ...
    "totalIQSupply()": FunctionFragment;
    "totalIQSupplyAt(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "toggleEmergencyUnlock",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "totalIQSupply",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "totalIQSupplyAt",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface HiIQAbi extends BaseContract {
  contractName: "HiIQAbi";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HiIQAbiInterface;
  ...
  functions: {
    ...
    totalIQSupply(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    totalIQSupply(overrides?: CallOverrides): Promise<PopulatedTransaction>;
